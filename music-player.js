...
const st=document.createElement('style');st.textContent=`#dtd-seasonal-accent{top:92px!important;right:8px!important}#dtd-seasonal-accent .holiday-art{transition:none!important;animation:none!important}@media(max-width:600px){#dtd-seasonal-accent{top:82px!important;right:6px!important}}`;document.head.appendChild(st);
const s=document.createElement('script');s.src='music-player-base.js?v=20260830STATICBASE2';
