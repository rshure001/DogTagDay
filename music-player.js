...
const st=document.createElement('style');st.textContent=`#dtd-seasonal-accent{top:auto!important;bottom:18px!important;right:14px!important;width:clamp(62px,8vw,98px)!important}#dtd-seasonal-accent .holiday-art{transition:none!important;animation:none!important}@media(max-width:600px){#dtd-seasonal-accent{top:auto!important;bottom:14px!important;right:10px!important;width:64px!important}}`;document.head.appendChild(st);
const s=document.createElement('script');s.src='music-player-base.js?v=20260830STATICBASE3';
