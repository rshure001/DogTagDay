...
/* Fallback story-wall repair: this intentionally lives in the legacy script too so an older cached homepage still upgrades itself in the browser. */
(() => {
  ...
  const lead = section?.querySelector('.story-lead');
  if (lead) lead.textContent = 'Community stories are posted publicly when submitted. Dog Tag Day may remove content afterward when necessary.';
